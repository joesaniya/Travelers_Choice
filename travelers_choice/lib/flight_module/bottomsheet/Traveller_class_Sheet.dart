...
import '../controller/Traveller_Class_Controller.dart';

class TravellerclassSheet extends StatefulWidget {
  const TravellerclassSheet({super.key});

  @override
  State<TravellerclassSheet> createState() => _TravellerclassSheetState();
}

class _TravellerclassSheetState extends State<TravellerclassSheet>
    with TickerProviderStateMixin {
  late TravellerClassController controller;
  ...
  void initState() {
    ...
    controller = FxControllerStore.put(TravellerClassController(this));
  ...
  Widget build(BuildContext context) {
    ...
    return FxBuilder<TravellerClassController>(
