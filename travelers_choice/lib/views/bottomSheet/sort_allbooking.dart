...
import '../../controllers/sort_allbooking.dart';
import '../../theme/app_theme.dart';

class SortAllBooking extends StatefulWidget {
  const SortAllBooking({super.key});

  @override
  State<SortAllBooking> createState() => _SortAllBookingState();
}

class _SortAllBookingState extends State<SortAllBooking>
    with TickerProviderStateMixin {
  late SortAllBookingController controller;
  ...
  void initState() {
    ...
    controller = FxControllerStore.put(SortAllBookingController(this));
  ...
  Widget build(BuildContext context) {
    ...
    return FxBuilder<SortAllBookingController>(
                            ...
                            InkWell(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  FxText.titleSmall("Status", fontWeight: 60),
                                ],
                              ),
                            ),
                            InkWell(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  FxText.titleSmall("Pending", fontWeight: 600),
                                ],
                              ),
                            ),
                          ],
