...
import '../../controllers/filter_booking_controller.dart';
import '../../theme/app_theme.dart';

class FilterAllBooking extends StatefulWidget {
  const FilterAllBooking({super.key});

  @override
  State<FilterAllBooking> createState() => _FilterAllBookingState();
}

class _FilterAllBookingState extends State<FilterAllBooking>
    with TickerProviderStateMixin {
  late FilterAllBookingController controller;
  ...
  void initState() {
    ...
    controller = FxControllerStore.put(FilterAllBookingController(this));
  ...
  Widget build(BuildContext context) {
    ...
    return FxBuilder<FilterAllBookingController>(
                            ...
                            InkWell(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  FxText.titleSmall("Newest First",
                                      fontWeight: 60),
                            ...
                            InkWell(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  FxText.titleSmall("Oldest First",
                                      fontWeight: 600),
                                ],
                              ),
                            ),
                            InkWell(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  FxText.titleSmall("high Price Range",
                                      fontWeight: 600),
                                ],
                              ),
                            ),
                            InkWell(
                              ...
                              child: Row(
                                children: <Widget>[
                                  ...
                                  FxText.titleSmall("Lowest Price Range",
                                      fontWeight: 600),
                                ],
                              ),
                            ),
