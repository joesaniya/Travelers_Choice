...
import '../controllers/Cart_Checkout_Controller.dart';
...
class _CartCheckOutScreenState extends State<CartCheckOutScreen>
  ...
  late CartCheckOutController controller;
  ...
  void initState() {
    ...
    controller = FxControllerStore.put(CartCheckOutController(this));
  ...
  getCheckoutTotalAmount(int index, Activity tour) {
    ...
    if (tour.promoAmount != null) {
      ...
      rateconversion =
          ((favouriteListCart[index].grandTotal * conversionRate!) -
      ...
      rateconversion = ((favouriteListCart[index].grandTotal * conversionRate!))
          .toStringAsFixed(2);
      log('Rate:$rateconversion');
      rateselectedtourOption =
          ((favouriteListCart[index].grandTotal * conversionRate!))
    ...
    return SizedBox(
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          log('PromoAmount:${favouriteListCart[index].promoAmount ?? '1'}');

          // controller.checkboxValue =
          //     List<bool>.generate(widget.length, (counter) => false);
          getCheckoutTotalAmount(index, favouriteListCart[index]);
                ...
                children: [
                    ...
                    children: [
                      ...
                      IconButton(
                        onPressed: () {
                          log('remove clicked');
                          setState(() {
                            favouriteListCart.removeAt(index);
                          });
                        },
                        icon: const Icon(
                          Icons.delete,
                      ...
                      Expanded(
                        child: Align(
                          ...
                          child: FxText.bodyMedium(
                            ...
                            favouriteListCart[index].name.toString(),
                            fontWeight: 700,
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      favouriteListCart[index].transferCode == null ||
                              favouriteListCart[index].transferCode!.isEmpty
                          ? FxText.bodyMedium(
                              'Without Transfer',
                              fontWeight: 700,
                            )
                          : FxText.bodyMedium(
                              favouriteListCart[index].transferCode.toString(),
                              fontWeight: 700,
                            ),
                    ],
                  ),
                  ...
                  favouriteListCart[index].activityTimeSlot == null
                      ? const SizedBox()
                      : Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                            ...
                            Row(
                              children: [
                                FxText.bodyMedium(
                                  // '20 Jul',
                                  getFormattedDate(favouriteListCart[index]
                                          .activityTimeSlot!
                                          .startDateTime
                                          .toString()
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      FxText.bodyMedium(
                        favouriteListCart[index].selectedDate.toString(),
                        fontWeight: 700,
                      ),
                  ...
                  //     : const SizedBox(),
                  FxSpacing.height(5),
                  favouriteListCart[index].isPromoCode == true
                      ? Container(
  ...
  Widget build(BuildContext context) {
    return FxBuilder<CartCheckOutController>(
...
//               "assets/images/apps/shopping2/icons/razor_logo.png", "CCavenue"),
          ...
          FxSpacing.height(20),
          FxButton.block(
            onPressed: favouriteListCart.isEmpty
                ? null
                : () {
                    token == null
                        ? controller.Login()
